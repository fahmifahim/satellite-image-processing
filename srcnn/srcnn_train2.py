...
def drop_resolution(x, scale):
    ...
    small_img_array = resize(x, small_size, anti_aliasing=True)
    reproduce_small_org = resize(small_img_array, img.size, anti_aliasing=True)

    return reproduce_small_org
