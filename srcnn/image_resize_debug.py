...
print("--Array1")
print(im2_array)
im_resize256 = im2.resize(size=(256,256), resample=Image.BICUBIC)
im_resize256_sequence = im_resize256.getdata()
im_resize256_array = img_to_array(im_resize256_sequence)
print("--Array2")
print(im_resize256_array)
